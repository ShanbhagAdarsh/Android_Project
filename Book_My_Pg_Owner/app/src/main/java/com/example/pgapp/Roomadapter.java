...
public class Roomadapter extends FirebaseRecyclerAdapter<RoomProfile, Roomadapter.personsViewholder> {
    ...
    public personsViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        return new Roomadapter.personsViewholder(view);
    }
        ...
        public personsViewholder(@NonNull View itemView)
        {
            ...
            itemView.setOnClickListener((new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(view.getContext(), DisplayRoomActivity.class);
