    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validate()) {
                    sendUserData();
                    startActivity(new Intent(userProfileEdit.this,ProfileFragment.class));
                }
                else
                {
                    Toast.makeText(userProfileEdit.this,"Enter all the Details correctly",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dpd = new DatePickerDialog(
                        userProfileEdit.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth
        ...
        reference.child(userid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (userProfile != null) {
                    ...
                    String nativearea=userProfile.userAREA;
                    String nativecity=userProfile.userCITY;
                    String nativepin=userProfile.userPINCODE;
                    String nativeState=userProfile.userSTATE;
                    String c_address=userProfile.userCurrentAddress;
                    String carea=userProfile.userCAREA;
                    String ccity=userProfile.userCCITY;
                    String cpin=userProfile.userCPINCODE;
                    String cState=userProfile.userCSTATE;


                    userfname.getEditText().setText(Name);
                    userEmail.getEditText().setText(mail);
                    usermobileno.getEditText().setText(Phone_Number);
                    age.getEditText().setText(Age);
                    occ.getEditText().setText(occu);
                    dob.setText(date);
                    userlocaladdress.getEditText().setText(Native_address);
                    userarea.getEditText().setText(nativearea);
                    usercity.getEditText().setText(nativecity);
                    userpincode.getEditText().setText(nativepin);
                    userstate.getEditText().setText(nativeState);
                    usercadd.getEditText().setText(c_address);
                    usercarea.getEditText().setText(carea);
                    userccity.getEditText().setText(ccity);
                    usercpincode.getEditText().setText(cpin);
                    usercstate.getEditText().setText(cState);

                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(userProfileEdit.this, "Error while loading", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void sendUserData(){
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(userProfileEdit.this,"Upload Failed",Toast.LENGTH_SHORT).show();
            }
        }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(userProfileEdit.this,"Upload Successful",Toast.LENGTH_SHORT).show();
            }
        });
